...
import com.widgets.management.api.infrastructure.persistence.MachineEventLogRepository;
...
public class MachineEventLogServiceTest {
    ...
    public void shouldReturnEmptyListIfFindByMachineReturnsNull(){
        ...
        Assertions.assertThat(eventLogServiceList).isEmpty();
    }
    ...
    public void shouldReturnMachineEventLogListIfFindByMachineReturnsList(){
        ...
        Assertions.assertThat(eventLogServiceList).isNotEmpty();
    }
}